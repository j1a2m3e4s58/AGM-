...
import { Download, ShieldCheck, TrendingUp, Users, UserCheck } from "lucide-react";
...
export default function BoardViewPage() {
  ...
  return (
    <Layout>
      <div className="mx-auto max-w-6xl space-y-6" data-ocid="board.page">
        ...
        <div className="grid gap-4 lg:grid-cols-[1.4fr_1fr]">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-base">Most Recent Registrations</CardTitle>
            </CardHeader>
